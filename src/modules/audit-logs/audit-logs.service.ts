...
const SECTION_ENTITY_TYPES: Record<string, string[]> = {
  ...
  finance: ['VOUCHER', 'DEPOSIT', 'CLASS_FEE_SCHEDULE', 'STUDENT_FEE_SCHEDULE', 'BULK_VOUCHER', 'CHEQUE', 'DISCOUNT_PRESET', 'STUDENT_FEE_INSTALLMENT'],
  ...
  attendance: ['STUDENT_ATTENDANCE', 'STAFF_ATTENDANCE', 'ATTENDANCE_OBJECTION', 'CLASS_ATTENDANCE_MODE', 'TIMETABLE', 'TIMETABLE_SLOT'],
