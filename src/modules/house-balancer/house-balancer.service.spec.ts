...
describe('HouseBalancerService', () => {
  function buildService(opts?: {
    ...
    const students =
      opts?.students ??
      [
        { cc: 1, full_name: 'A', house_id: 10, houses: { id: 10, house_name: 'Red', house_color: '#f00' } },
        { cc: 2, full_name: 'B', house_id: 10, houses: { id: 10, house_name: 'Red', house_color: '#f00' } },
        { cc: 3, full_name: 'C', house_id: 11, houses: { id: 11, house_name: 'Blue', house_color: '#00f' } },
        { cc: 4, full_name: 'D', house_id: null, houses: null },
      ];
    const houses =
      opts?.houses ??
      [
